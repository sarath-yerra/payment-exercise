...
RSpec.describe PaymentsController, type: :controller do
  describe '#index' do
    ...
    it 'should responds with a 200' do
  ...
  describe '#show' do
    ...
    context 'when payment is not found' do
      it 'should responds with a 404' do
